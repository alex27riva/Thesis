...
\usepackage{fancybox}
\usepackage{enumitem}
%\usepackage[toc,page]{appendix} %test appendice
%\usepackage{wrapfig} %Figure nel testo
\usepackage{dirtree}
...
\def\cleardoublepage{\clearpage\if@twoside \ifodd\c@page\else%
    ...
    %\newpage%               togliere commento per avere pagine bianche
    \if@twocolumn\hbox{}\newpage\fi\fi\fi}
\makeatother
...
\include{content/7_Deployment}
\include{content/8_RealizzazioneSito}
